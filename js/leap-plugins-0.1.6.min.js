...
(function() {
    ...
    if (a = function() {
        var a;
        return a = [], this.on("deviceDisconnected", function() {
            for (var b = 0, c = a.length; c > b; b++) id = a[b], a.splice(b, 1), this.emit("handLost", this.lastConnectionFrame.hand(id)), b--, c--
        }), {
            frame: function(b) {
                var c, d, e, f, g;
                ...
                for (var h = 0, i = a.length; i > h; h++) c = a[h], -1 == d.indexOf(c) && (a.splice(h, 1), this.emit("handLost", this.frame(1).hand(c)), h--, i--);
                for (g = [], e = 0, f = d.length; f > e; e++) c = d[e], -1 === a.indexOf(c) ? (a.push(c), g.push(this.emit("handFound", b.hand(c)))) : g.push(void 0);
                return g
            }
        }
    }, "undefined" != typeof Leap && Leap.Controller) Leap.Controller.plugin("handEntry", a);
    else {
        if ("undefined" == typeof module) throw "leap.js not included";
        module.exports.handEntry = a
    }
}).call(this),
function() {
    var a;
    if (a = function() {
        ...
        return b = {}, a = function(a, c, d) {
            var e, f, g, h;
            if (b[g = a + this.id] || (b[g] = []), e = b[a + this.id], void 0 !== d) return e[c] = d;
            if ("[object String]" === {}.toString.call(c)) return e[c];
            h = [];
            for (f in c) d = c[f], h.push(void 0 === d ? delete e[f] : e[f] = d);
            return h
        }, {
            hand: {
                data: function(b, c) {
                    return a.call(this, "h", b, c)
                },
                hold: function(a) {
                    return a ? this.data({
                        holding: a
            ...
            pointable: {
                data: function(b, c) {
                    return a.call(this, "p", b, c)
                }
            }
        }
    }, "undefined" != typeof Leap && Leap.Controller) Leap.Controller.plugin("handHold", a);
    else {
        if ("undefined" == typeof module) throw "leap.js not included";
        module.exports.handHold = a
    }
}.call(this),
function(a, b) {
    "use strict";
    ...
    function c(a) {
        this.options = a || (a = {}), this.loading = !1, this.timeBetweenLoops = a.timeBetweenLoops || 50, this.packingStructure = ["id", "timestamp", {
            hands: [
                ["id", "type", "direction", "palmNormal", "palmPosition", "palmVelocity", "stabilizedPalmPosition", "pinchStrength", "grabStrength", "confidence"]
            ]
        }, {
            pointables: [
                ["id", "direction", "handId", "length", "stabilizedTipPosition", "tipPosition", "tipVelocity", "tool", "carpPosition", "mcpPosition", "pipPosition", "dipPosition", "btipPosition", "bases", "type"]
            ]
        }, {
            interactionBox: ["center", "size"]
        }], this.setFrames(a.frames || [])
    }
    var d = {
        ...
        compressToBase64: function(a) {
            ...
            var b, c, e, f, g, h, i, j = "",
                k = 0;
            for (a = d.compress(a); k < 2 * a.length;) k % 2 == 0 ? (b = a.charCodeAt(k / 2) >> 8, c = 255 & a.charCodeAt(k / 2), e = k / 2 + 1 < a.length ? a.charCodeAt(k / 2 + 1) >> 8 : 0 / 0) : (b = 255 & a.charCodeAt((k - 1) / 2), (k + 1) / 2 < a.length ? (c = a.charCodeAt((k + 1) / 2) >> 8, e = 255 & a.charCodeAt((k + 1) / 2)) : c = e = 0 / 0), k += 3, f = b >> 2, g = (3 & b) << 4 | c >> 4, h = (15 & c) << 2 | e >> 6, i = 63 & e, isNaN(c) ? h = i = 64 : isNaN(e) && (i = 64), j = j + d._keyStr.charAt(f) + d._keyStr.charAt(g) + d._keyStr.charAt(h) + d._keyStr.charAt(i);
            return j
        },
        decompressFromBase64: function(a) {
            ...
            var b, c, e, f, g, h, i, j, k = "",
                ...
                m = 0,
                n = d._f;
            for (a = a.replace(/[^A-Za-z0-9\+\/\=]/g, ""); m < a.length;) g = d._keyStr.indexOf(a.charAt(m++)), h = d._keyStr.indexOf(a.charAt(m++)), i = d._keyStr.indexOf(a.charAt(m++)), j = d._keyStr.indexOf(a.charAt(m++)), c = g << 2 | h >> 4, e = (15 & h) << 4 | i >> 2, f = (3 & i) << 6 | j, l % 2 == 0 ? (b = c << 8, 64 != i && (k += n(b | e)), 64 != j && (b = f << 8)) : (k += n(b | c), 64 != i && (b = e << 8), 64 != j && (k += n(b | f))), l += 3;
            return d.decompress(k)
        },
        compressToUTF16: function(a) {
            ...
            var b, c, e, f = "",
                g = 0,
                h = d._f;
            for (a = d.compress(a), b = 0; b < a.length; b++) switch (c = a.charCodeAt(b), g++) {
                case 0:
                    f += h((c >> 1) + 32), e = (1 & c) << 14;
                    break;
                case 1:
                    f += h(e + (c >> 2) + 32), e = (3 & c) << 13;
                    break;
                case 2:
                    f += h(e + (c >> 3) + 32), e = (7 & c) << 12;
                    break;
                case 3:
                    f += h(e + (c >> 4) + 32), e = (15 & c) << 11;
                    break;
                case 4:
                    f += h(e + (c >> 5) + 32), e = (31 & c) << 10;
                    break;
                case 5:
                    f += h(e + (c >> 6) + 32), e = (63 & c) << 9;
                    break;
                case 6:
                    f += h(e + (c >> 7) + 32), e = (127 & c) << 8;
                    break;
                case 7:
                    f += h(e + (c >> 8) + 32), e = (255 & c) << 7;
                    break;
                case 8:
                    f += h(e + (c >> 9) + 32), e = (511 & c) << 6;
                    break;
                case 9:
                    f += h(e + (c >> 10) + 32), e = (1023 & c) << 5;
                    break;
                case 10:
                    f += h(e + (c >> 11) + 32), e = (2047 & c) << 4;
                    break;
                case 11:
                    f += h(e + (c >> 12) + 32), e = (4095 & c) << 3;
                    break;
                case 12:
                    f += h(e + (c >> 13) + 32), e = (8191 & c) << 2;
                    break;
                case 13:
                    f += h(e + (c >> 14) + 32), e = (16383 & c) << 1;
                    break;
                case 14:
                    f += h(e + (c >> 15) + 32, (32767 & c) + 32), g = 0
            }
            return f + h(e + 32)
        },
        decompressFromUTF16: function(a) {
            if (null == a) return "";
            for (var b, c, e = "", f = 0, g = 0, h = d._f; g < a.length;) {
                switch (c = a.charCodeAt(g) - 32, f++) {
                    case 0:
                        b = c << 1;
                        break;
                    case 1:
                        e += h(b | c >> 14), b = (16383 & c) << 2;
                        break;
                    case 2:
                        e += h(b | c >> 13), b = (8191 & c) << 3;
                        break;
                    case 3:
                        e += h(b | c >> 12), b = (4095 & c) << 4;
                        break;
                    case 4:
                        e += h(b | c >> 11), b = (2047 & c) << 5;
                        break;
                    case 5:
                        e += h(b | c >> 10), b = (1023 & c) << 6;
                        break;
                    case 6:
                        e += h(b | c >> 9), b = (511 & c) << 7;
                        break;
        ...
        compress: function(a) {
            ...
            for (e = 0; e < a.length; e += 1)
                if (h = a.charAt(e), Object.prototype.hasOwnProperty.call(f, h) || (f[h] = l++, g[h] = !0), i = j + h, Object.prototype.hasOwnProperty.call(f, i)) j = i;
                else {
                    if (Object.prototype.hasOwnProperty.call(g, j)) {
                        if (j.charCodeAt(0) < 256) {
                            for (b = 0; m > b; b++) o <<= 1, 15 == p ? (p = 0, n += q(o), o = 0) : p++;
                            for (c = j.charCodeAt(0), b = 0; 8 > b; b++) o = o << 1 | 1 & c, 15 == p ? (p = 0, n += q(o), o = 0) : p++, c >>= 1
                        } else {
                            for (c = 1, b = 0; m > b; b++) o = o << 1 | c, 15 == p ? (p = 0, n += q(o), o = 0) : p++, c = 0;
                            for (c = j.charCodeAt(0), b = 0; 16 > b; b++) o = o << 1 | 1 & c, 15 == p ? (p = 0, n += q(o), o = 0) : p++, c >>= 1
                        }
                        k--, 0 == k && (k = Math.pow(2, m), m++), delete g[j]
                    } else
                        for (c = f[j], b = 0; m > b; b++) o = o << 1 | 1 & c, 15 == p ? (p = 0, n += q(o), o = 0) : p++, c >>= 1;
            ...
            for (c = 2, b = 0; m > b; b++) o = o << 1 | 1 & c, 15 == p ? (p = 0, n += q(o), o = 0) : p++, c >>= 1;
            for (;;) {
                if (o <<= 1, 15 == p) {
                    n += q(o);
                    break
    ...
    "undefined" != typeof module && null != module && (module.exports = d),
    function() {
        if ("undefined" == typeof a.performance && (a.performance = {}), !a.performance.now) {
            var b = Date.now();
        ...
        setFrames: function(a) {
            this.frameData = a, this.frameIndex = 0, this.frameCount = a.length, this.leftCropPosition = 0, this.rightCropPosition = this.frameCount, this.setMetaData()
        },
        addFrame: function(a) {
            this.frameData.push(a)
        },
        currentFrame: function() {
            return this.frameData[this.frameIndex]
        },
        nextFrame: function() {
            var a = this.frameIndex + 1;
            return a %= this.rightCropPosition || 1, a < this.leftCropPosition && (a = this.leftCropPosition), this.frameData[a]
        },
        advanceFrame: function() {
            return this.frameIndex++, this.frameIndex >= this.rightCropPosition && !this.options.loop ? (this.frameIndex--, !1) : (this.frameIndex = this.frameIndex % (this.rightCropPosition || 1), this.frameIndex < this.leftCropPosition && (this.frameIndex = this.leftCropPosition), !0)
        },
        readyPlay: function() {
            this.frameIndex++, this.frameIndex >= this.rightCropPosition ? (this.frameIndex = this.frameIndex % (this.rightCropPosition || 1), this.frameIndex < this.leftCropPosition && (this.frameIndex = this.leftCropPosition)) : this.frameIndex--
        },
        cloneCurrentFrame: function() {
            return JSON.parse(JSON.stringify(this.currentFrame()))
        },
        createLerpFrameData: function(a) {
            for (var b, c, d, e = this.currentFrame(), f = this.nextFrame(), g = ["palmPosition", "stabilizedPalmPosition", "sphereCenter", "direction", "palmNormal", "palmVelocity"], h = ["mcpPosition", "pipPosition", "dipPosition", "tipPosition", "direction"], i = this.cloneCurrentFrame(), j = i.hands.length, k = i.pointables.length, l = g.length, m = h.length, n = 0; j > n; n++) {
                c = i.hands[n];
                for (var o = 0; l > o; o++) b = g[o], e.hands[n][b] && f.hands[n] && (Leap.vec3.lerp(c[b], e.hands[n][b], f.hands[n][b], a), console.assert(c[b]))
            }
            for (n = 0; k > n; n++)
                for (d = i.pointables[n], o = 0; m > o; o++) b = h[o], e.pointables[n][b] && f.hands[n] && Leap.vec3.lerp(d[b], e.pointables[n][b], f.pointables[n][b], 0);
            return i
        },
        timeToNextFrame: function() {
            var a = (this.nextFrame().timestamp - this.currentFrame().timestamp) / 1e3;
            return 0 > a && (a = this.timeBetweenLoops), console.assert(!isNaN(a)), a
        },
        blank: function() {
            return 0 === this.frameData.length
        },
        leftCrop: function() {
        ...
        cullFrames: function(a) {
            console.log("cull frames", a), a || (a = 1);
            for (var b = 0; b < this.frameData.length; b++) this.frameData.splice(b, a);
            this.setMetaData()
        },
        frameRate: function() {
            return 0 == this.frameData.length ? 0 : this.frameData.length / (this.frameData[this.frameData.length - 1].timestamp - this.frameData[0].timestamp) * 1e6
        },
        ...
        setMetaData: function() {
            ...
            for (var b in a) this.metadata[b] = a[b]
        },
        packedFrameData: function() {
            var a, b = this.croppedFrameData(),
                c = [];
            c.push(this.packingStructure);
            for (var d = 0, e = b.length; e > d; d++) a = b[d], c.push(this.packArray(this.packingStructure, a));
            return c
        },
        packArray: function(a, b) {
            for (var c, d = [], e = 0, f = a.length; f > e; e++)
                if (c = a[e], "string" == typeof c) d.push(b[c]);
                else
            if ("[object Array]" == Object.prototype.toString.call(c))
                for (var g = 0, h = b.length; h > g; g++) d.push(this.packArray(c, b[g]));
            else {
                console.assert(c);
                for (var i in c) break;
                console.assert(i), console.assert(c[i]), console.assert(b[i]), d.push(this.packArray(c[i], b[i]))
            }
            return d
        },
        unPackFrameData: function(a) {
            for (var b, c = a[0], d = [], e = 1, f = a.length; f > e; e++) b = a[e], d.push(this.unPackArray(c, b));
            return d
        },
        unPackArray: function(a, b) {
            for (var c, d = {}, e = 0, f = a.length; f > e; e++)
                if (c = a[e], "string" == typeof c) d[c] = b[e];
                else {
                    if ("[object Array]" == Object.prototype.toString.call(c)) {
                        for (var g = [], h = 0, i = b.length; i > h; h++) g.push(this.unPackArray(c, b[h]));
                        return g
                    }
                    for (var j in c) break;
                    d[j] = this.unPackArray(c[j], b[e])
                }
            return d
        },
        toHash: function() {
        ...
        "export": function(a) {
            var b = JSON.stringify(this.toHash());
            return "json" == a ? b : d.compressToBase64(b)
        },
        save: function(a) {
            var b;
            b = this.metadata.title ? this.metadata.title.replace(/\s/g, "") : "leap-playback-recording", this.metadata.frameRate && (b += "-" + Math.round(this.metadata.frameRate) + "fps"), "json" === a ? saveAs(new Blob([this.export("json")], {
                type: "text/JSON;charset=utf-8"
            }), b + ".json") : saveAs(new Blob([this.export("lz")], {
                type: "application/x-gzip;charset=utf-8"
            }), b + ".json.lz")
        },
        decompress: function(a) {
            return d.decompressFromBase64(a)
        },
        loaded: function() {
    ...
    function() {
        ...
        d.prototype = {
            ...
            pause: function() {
                this.state = "idle", this.hideOverlay(), this.controller.emit("playback.pause", this)
            },
            idle: function() {
                this.state = "idle", this.controller.connection.protocol = this.stopProtocol
            },
            toggle: function() {
                "idle" == this.state ? this.play() : "playing" == this.state && this.pause()
            },
            record: function() {
                this.clear(), this.stop(), this.state = "recording", this.controller.connection.protocol = this.recordProtocol, this.setGraphic("connect"), this.controller.emit("playback.record", this)
            },
            clear: function() {
                if (this.recording && !this.recording.blank()) {
                    var a = this.recording.cloneCurrentFrame();
                    a.hands = [], a.fingers = [], a.pointables = [], a.tools = [], this.sendImmediateFrame(a)
                }
            },
            recordPending: function() {
                return "recording" == this.state && this.recording.blank()
            },
            isRecording: function() {
                return "recording" == this.state && !this.recording.blank()
            },
            finishRecording: function() {
                this.controller.connection.protocol = this.playbackProtocol, this.recording.setFrames(this.recording.frameData), this.controller.emit("playback.recordingFinished", this)
            },
            loaded: function() {
            ...
            play: function() {
                if ("playing" !== this.state && !this.loading() && !this.recording.blank()) {
                    this.state = "playing", this.controller.connection.protocol = this.playbackProtocol;
                    var a = this;
                    this.controller.connection.removeAllListeners("frame"), this.controller.connection.on("frame", function(b) {
                        a.autoPlay && "idle" == a.state && 0 == b.hands.length && a.play(), a.controller.processFrame(b)
                    }), this.resetTimers(), this.recording.readyPlay(), this.stepFrameLoop(), this.controller.emit("playback.play", this)
                }
            },
            recordFrameHandler: function(a) {
                this.setGraphic("wave"), a.hands.length > 0 ? (this.recording.addFrame(a), this.hideOverlay()) : this.recording.blank() || this.finishRecording()
            },
            setRecording: function(a) {
                var b = this;
                this.pause();
                var d = function(a) {
                    return this.setFrames(a), b.recording != this ? void console.log("recordings changed during load") : (b.autoPlay && (b.play(), b.pauseOnHand && b.setGraphic("connect")), void b.controller.emit("playback.recordingSet", this))
                };
                return this.recording = a, a instanceof c || (this.recording.__proto__ = c.prototype, c.call(this.recording, {
                    timeBetweenLoops: this.options.timeBetweenLoops,
                    loop: this.options.loop,
                    loadProgress: function(a, c, d) {
                        b.controller.emit("playback.ajax:progress", a, c, d)
                    }
                })), this.recording.loaded() ? d.call(this.recording, this.recording.frameData) : a.url && (this.controller.emit("playback.ajax:begin", this, this.recording), this.recording.loadFrameData(function(a) {
                    d.call(this, a), b.controller.emit("playback.ajax:complete", b, this)
                })), this
            },
            hideOverlay: function() {
                this.overlay && (this.overlay.style.display = "none")
            },
            setGraphic: function(a) {
                if (this.overlay && this.graphicName != a) switch (this.graphicName = a, a) {
                    case "connect":
                        this.overlay.style.display = "block", this.overlay.innerHTML = e;
                        break;
                    case "wave":
                        this.overlay.style.display = "block", this.overlay.innerHTML = f;
                        break;
                    case b:
        ...
        var g = function(c) {
            ...
            var g = c.pauseOnHand;
            g === b && (g = !0);
            var h = c.timeBetweenLoops;
            h === b && (h = 50);
            var i = c.requiredProtocolVersion,
                j = c.pauseHotkey;
            j === b && (j = 32);
            var k = c.loop;
            k === b && (k = !0);
            var l = c.overlay;
            l === b && document.body && (l = document.createElement("div"), document.body.appendChild(l), l.style.width = "100%", l.style.position = "absolute", l.style.top = "0", l.style.left = "-" + a.getComputedStyle(document.body).getPropertyValue("margin"), l.style.padding = "10px", l.style.textAlign = "center", l.style.fontSize = "18px", l.style.opacity = "0.8", l.style.display = "none", l.style.zIndex = "10", l.id = "connect-leap", l.style.cursor = "pointer", l.addEventListener("click", function() {
                return this.style.display = "none", !1
            }, !1)), c.player = new d(this, {
                recording: c.recording,
                loop: k,
                pauseHotkey: j,
                timeBetweenLoops: h
            }), c.player.overlay = l, c.player.pauseOnHand = g, c.player.requiredProtocolVersion = i, c.player.autoPlay = f;
            var m = function() {
                return c.player.pauseOnHand && e.connection.opts.requestProtocolVersion < c.requiredProtocolVersion ? (console.log("Protocol Version too old (" + e.connection.opts.requestProtocolVersion + "), disabling device interaction."), void(c.player.pauseOnHand = !1)) : (f && (e.on("streamingStarted", function() {
                    "recording" == c.player.state ? (c.player.pause(), c.player.setGraphic("wave")) : g ? c.player.setGraphic("wave") : c.player.setGraphic()
                }), e.on("streamingStopped", function() {
                    c.player.play()
                })), void e.on("streamingStopped", function() {
                    c.player.setGraphic("connect")
                }))
            };
            return this.connection.connected ? m() : this.on("ready", m), {}
        };
        if ("undefined" != typeof Leap && Leap.Controller) Leap.Controller.plugin("playback", g);
        else {
            if ("undefined" == typeof module) throw "leap.js not included";
            module.exports.playback = g
        }
    }.call(this)
}(window),
function() {
    ...
    if (a = function(a) {
        var b, c, d, e;
        return null == a && (a = {}), a.positioning || (a.positioning = "absolute"), a.scale || (a.scale = 1), a.scaleX || (a.scaleX = 1), a.scaleY || (a.scaleY = 1), a.scaleZ || (a.scaleZ = 1), a.verticalOffset || (a.verticalOffset = 0), b = 6, c = -100, e = {
            absolute: function(d) {
            ...
            var d;
            return null == c && (c = !1), d = "function" == typeof a.positioning ? a.positioning.call(this, b) : e[a.positioning].call(this, b), c && (this.screenPositionVec3 = d), d
        }, {
            hand: {
    ...
    }, "undefined" != typeof Leap && Leap.Controller) Leap.Controller.plugin("screenPosition", a);
    else {
        if ("undefined" == typeof module) throw "leap.js not included";
        module.exports.screenPosition = a
    }
}.call(this),
function() {
    var a;
    if (a = function(a) {
        return a.alert || (a.alert = !1), a.requiredProtocolVersion || (a.requiredProtocolVersion = 6), a.disconnect || (a.disconnect = !0), "undefined" != typeof Leap && Leap.Controller && Leap.version.minor < 5 && Leap.version.dot < 4 && console.warn("LeapJS Version Check plugin incompatible with LeapJS pre 0.4.4"), this.on("ready", function() {
            var b, c, d;
            return d = a.requiredProtocolVersion, b = this.connection.opts.requestProtocolVersion, d > b ? (c = "Protocol Version too old. v" + d + " required, v" + b + " available.", a.disconnect && (this.disconnect(), c += " Disconnecting."), console.warn(c), a.alert && alert("Your Leap Software version is out of date.  Visit http://www.leapmotion.com/setup to update"), this.emit("versionCheck.outdated", {
                required: d,
                current: b,
                disconnect: a.disconnect
            })) : void 0
        }), {}
    }, "undefined" != typeof Leap && Leap.Controller) Leap.Controller.plugin("versionCheck", a);
    else {
        if ("undefined" == typeof module) throw "leap.js not included";
        module.exports.versionCheck = a
    }
}.call(this);